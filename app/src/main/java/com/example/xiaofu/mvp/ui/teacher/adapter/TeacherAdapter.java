package com.example.xiaofu.mvp.ui.teacher.adapter;
...
//         佛祖保佑       永无BUG     永不修改                     //
////////////////////////////////////////////////////////////////////
public class TeacherAdapter extends BaseQuickAdapter<TeacherBean.BodyBean.ResultBean, BaseViewHolder> {
    public TeacherAdapter(int layoutResId, List data) {
